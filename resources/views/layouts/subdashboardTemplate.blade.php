            ...
            <div style="margin-top: 10px;" class="sidebar-nav slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    <li style="padding: 70px 0 0;">
                        <a style="font-size: 1em; font-weight: bold; color: white;" href="{{ url('subdashboard', $id) }}" class="waves-effect"><i class="fa  fa-home fa-fw" aria-hidden="true"></i>Principal</a>
                    </li>
                    <hr style="background-color: white;">
                    <li>
                        <a style="font-size: 1em; font-weight: bold; color: white;" href="{{ url('subdashboardc', $id) }}" class="waves-effect"><i class="fa  fa-list-alt fa-fw" aria-hidden="true"></i>Cajeros</a>
                    </li>
                    <hr style="background-color: white;">
                    <li>
                        <a style="font-size: 1em; font-weight: bold; color: white;" href="{{ url('subdashboardq', $id) }}" class="waves-effect"><i class="fa fa-users fa-fw" aria-hidden="true"></i>Colas</a>
                    </li>
                    <hr style="background-color: white;">
                </ul>
            </div>
