        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header" style="background-color: #1A8FD8;">
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    <li>
                        <h3 style="font-size: 1em; font-weight: bold; color: white; margin-right: 3px;">Bienvenido, {{ Auth::user()->nombre }}</h3>
                    </li>
                    <li>
                        <a class="profile-pic" href="{{ route('logout') }}" onclick="event.preventDefault();
                            document.getElementById('logout-form').submit();"> <img src="../assets/plugins/images/users/varun.jpg" alt="user-img" width="36" class="img-circle"><b class="hidden-xs">Salir</b></a>
            ...
            <div style="margin-top: 10px;" class="sidebar-nav slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    <li style="padding: 70px 0 0;">
                        <a style="font-size: 1em; font-weight: bold; color: white;" href="{{ route('dashboard') }}" class="waves-effect"><i class="fa fa-home fa-fw" aria-hidden="true"></i>Principal</a>
                    </li>
                    <hr style="background-color: white;">
                    <li>
                        <a style="font-size: 1em; font-weight: bold; color: white;" href="{{ route('dashboards') }}" class="waves-effect"><i class="fa fa-building fa-fw" aria-hidden="true"></i>Sucursales</a>
                    </li>
                    <hr style="background-color: white;">
                    <li>
                        <a style="font-size: 1em; font-weight: bold; color: white;" href="{{ route('dashboardlc') }}" class="waves-effect"><i class="fa  fa-list-alt fa-fw" aria-hidden="true"></i>Cajeros</a>
                    </li>
                    <hr style="background-color: white;">
                    <li>
                        <a style="font-size: 1em; font-weight: bold; color: white;" href="{{ route('dashboardlq') }}" class="waves-effect"><i class="fa fa-users fa-fw" aria-hidden="true"></i>Colas</a>
                    </li>
                    <hr style="background-color: white;">
                </ul>
            </div>
