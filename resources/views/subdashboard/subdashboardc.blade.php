    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12">
                <div class="white-box">
                    <a href="{{url('subdashboardrc', $id)}}" class="btn btn-danger pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"><i class="fa fa-home"></i> Crear cajero</a>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a class="boton-admin-table" href="{{url('subdashboarduc', array('id'=>$id, 'uid'=>Crypt::encrypt($cashier->id)))}}"><i class="fa fa-edit"></i></a>
                                    <a class="boton-admin-table" href="{{url('subdashboarddc', array('id'=>$id, 'uid'=>Crypt::encrypt($cashier->id)))}}"><i class="fa fa-trash"></i></a></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
